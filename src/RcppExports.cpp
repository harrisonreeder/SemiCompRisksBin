...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(WeibSCRmcmc(y1, y_sm, delta1, delta1noD, delta_cr, delta_sm, Xmat1, Xmat2, Xmat3, hyper_vec, tuning_vec, start_vec, n_burnin, n_sample, thin, frail_path));
    return rcpp_result_gen;
END_RCPP
}
// WeibSCRlogitmcmc
